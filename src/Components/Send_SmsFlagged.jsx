...
function Send_SmsFlagged() {
  ...
  const handleSendSms = async () => {
    try {
      ...
      const response = await axios.post(`${config.API_BASE_URL}/SendSmsFlagged/${id}`, formData,{
        headers: {
          'Authorization': `Bearer ${token}`,
        },
      });
        ...
        {loading ? (
          ...
          <div className='col-sm-6 offset-sm-3'>
            ...
            <input
              ...
              value={description}
              className="form-control"
              placeholder="Enter Flagged description"
              required
            ...
            <input
              ...
              min="1"
              className="form-control"
              placeholder="Enter Flagged Car License Plate"
              required
...
export default Send_SmsFlagged;
